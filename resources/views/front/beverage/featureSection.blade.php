<section class="category-area category-3 bg-primary ptb-100 bg-img"
    data-bg-image="{{ asset('assets/front/img/' . $be->feature_section_bg_image) }}" style="">
    <div class="container">
        <div class="row">
            <div class="col-12">
    ...
    @if ($bs->features_section_top_shape_image)
        <div class="bg-shape">
            <img class="lazyload" data-src="{{ asset('assets/front/img/' . $bs->features_section_top_shape_image) }}"
                alt="Bg Shape">
        </div>
    @endif
    @if ($bs->features_section_bottom_shape_image)
        <div class="bg-shape h-auto">
            <img class="lazyload" data-src="{{ asset('assets/front/img/' . $bs->features_section_bottom_shape_image) }}"
                alt="Bg Shape">
        </div>
    @endif
</section>
