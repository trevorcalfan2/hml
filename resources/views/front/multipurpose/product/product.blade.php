    ...
    @if ($be->menu_version == 2)
        <section class="food-menu-area food-menu-2-area food-menu-3-area pt-90" >
            <div class="container">
                                ...
                                <li class="nav-item" >
                                    <a class="nav-link {{$keys == 0 ? 'active' : ''}}" id="{{convertUtf8($category->slug)}}-tab" data-toggle="pill" href="#{{convertUtf8($category->slug)}}" role="tab" aria-controls="{{convertUtf8($category->slug)}}" aria-selected="true">
                                        @if (!empty($category->image))
                                            <img  class="lazy wow fadeIn w-50"  data-src="{{asset('assets/front/img/category/'.$category->image)}}" alt="menu" data-wow-delay=".5s">
                                        @endif
                ...
                <div class="row" >
                    <div class="col-lg-6">
                        <div class="tabs-btn pb-30" >
                            <ul class="nav nav-pills d-flex justify-content-center" >
                            
                            <a  href="https://drive.google.com/file/d/1mQBnTqw-cHDrsekayjaA5y_VVFaPb2AS/view?usp=sharing" target="_blank" style="font-size:20px; background-color:#FF6000; " class="btn btn-md  m-1 text-light w-100"><i class="fas fa-book-open"></i> Carta Esperanza</a>
                    ...
                    <div class="col-lg-6">
                        <div class="tabs-btn pb-20" >
                            ...
                            <a href="https://drive.google.com/file/d/1AKUdMAa9OsGm7t01ZL8jKHT9xb1eHFB9/view?usp=sharing" target="_blank" style="font-size:20px; background-color:#FF6000; " class="btn btn-md  m-1 text-light w-100"><i class="fas fa-book-open"></i> Carta Benavides</a>
                                            ...
                                            <div class="single-menu-item mt-30 sub{{$product->subcategory_id}}" >
                                                <div class="item-details" >
                                                    ...
                                                    <div class="menu-content ml-30">
                                                        <p class="title" >{{convertUtf8($product->title)}}</p>
                                                        <p>{{convertUtf8(strlen($product->summary)) > 90 ? substr(convertUtf8($product->summary), 0, 90) . '...' : convertUtf8($product->summary)}} </p>
                                                    </div>
                                                </div>
