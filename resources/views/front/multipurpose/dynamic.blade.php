            ...
            <div class="row align-items-center gx-xl-5" data-aos="fade-up"   >
                <div class="col-lg-6" data-aos="fade-up">
                        <div class="image  img-left " data-speed="0.1" data-revert="true">
                            ...
                            <iframe   width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=700&amp;height=400&amp;hl=es&amp;q=calle%20esperanza%20154%20Lima+(C.%20Esperanza%20154,%20Miraflores%2015074)&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                            </div>
                        </div>
                </div>
                <div class="col-lg-6" data-aos="fade-up">
                        ...
                        <div class="row align-items-center gx-xl-5"    >
                            ...
                            <div class="col-lg-6 pb-10">
                                <div class="tabs-btn  >
                                    ...
                                    <a href="https://https://bit.ly/cartachamiesperanza" target="_blank" style="font-size:20px; background-color:#FF6000;width:100% " class="btn btn-md  m-1 text-light">Carta Esperanza</a>
...
@if($page->name == 'Historia')
<div style="font-family: 'Satisfy', cursive;">
<section class=" pb-90 pt-100 " >
                            ...
                            <div class="col-lg-5"   >
                                <div class="content-title mb-40 ps-xl-2">
                                   ...
                                   ORIGEN
                                    ...
                                    <div class="btn-groups gap-25 mt-10"  ></div>
                        ...
                        <div class="row align-items-center gx-xl-5"  >
                            ...
                            <div class="col-lg-4"   >
                                <div class="content-title mb-40 " style="text-align:right" >
                                    ...
                                    <h2 class="title mb-30 mt-30" style="font-family: 'CG Times Bold'; font-size:40px">TRAYECTORIA</h2>
                                    <div class="content-text display-4"  style=font-size:42px !important">
                                            <span>
                                    ...
                                    <div class="btn-groups gap-25 mt-10"  >
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8 "    >
...
<figure>
                                                ...
                                                <figcaption class="text-center">Fotografia tomada por la revista Somos (1970)</figcaption>
                            </figure>
                            ...
                            <div class="col-lg-8 "    >
                                ...
                                <figure>
                                    <img class="lazyload blur-up" style="border-radius: 10px;" src="{{ asset('assets/front/img/old/2.jpg') }}" 
                                        ...
                                        <figcaption class="text-center"> Fotografia tomada junto al entonces alcalde de lima, el Sr. Alfonzo Barrantes</figcaption>
                                </figure>
                                </div>
                            </div>
                            <div class="col-lg-4"   >
                            ...
                            <div class="col-lg-4"   >
                                <div class="content-title mb-40 " style="text-align:right" >
                                    ...
                                    <div class="content-text display-4 "  style=font-size:42px !important">
                                        ...
                                        Ubicada en la Calle Esperanza 154 – Miraflores, la cual mantiene la esencia y decoracion desde hace 54 años.                         
                        ...
                        <div class="row align-items-center gx-xl-5"  >
                            ...
                            <div class="col-lg-5"   >
                                <div class="content-title mb-40 ps-xl-2">
                                    ...
                                    <div class="content-text display-4 mt-30"  style=font-size:42px !important">
                                        <span>
                        ...
                        <div class="row align-items-center gx-xl-5"  >
                            ...
                            <div class="col-lg-6"   >
                                <div class="content-title mb-40 ps-xl-2">
                                    ...
                                    <div class="content-text display-4"  style=font-size:42px !important">
                                        <span>
                                        "Conformando así La Familia Rincón Chami."
                                ...
                                <div class="content-title mb-40 " style="text-align:right" >
                                    <h2 class="title mb-30 mt-30" style="font-family: 'CG Times Bold';">
                                      ACTUALIDAD
                                        ...
                                        Actualmente contamos con 2 sedes ubicadas en Miraflores y ofrecemos una amplia variedad de platos ¡No olvides revisar <a style="color:#FF6000" href="http://localhost:8888/supervBackUp/menus">nuestra carta</a>!.                                         
