...
<!--   hero area end    -->
    <!--====== CHECKOUT PART START ======-->
    <div class="container mt-20" ><h3 class="text-danger text-center pb-50" >EL HORARIO DE PEDIDO ONLINE ES DE 12PM A 5PM, 
                                EL SISTEMA NO LE PERMITIRA CONTINUAR CON LA COMPRA 
                                SI ESTA FUERA DEL HORARIO ESTABLECIDO, 
                                RECOMENDAMOS INTENTAR NUEVAMENTE DENTRO DEL HORARIO ESTABLECIDO</h3>
</div>
