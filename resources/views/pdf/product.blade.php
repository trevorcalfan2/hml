            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                <h3><strong>Detalles del pedido</strong></h3>
                            </div>
                            <table class="table table-striped">
                                <tbody>
                                    ...
                                    @endif
                                  <tr>
                                    <th scope="row">Número de orden:</th>
                                    <td>#{{$order->order_number}}</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Fecha de orden:</th>
                                  ...
                                  @if (!empty($order->shipping_method))
                                    <tr>
                                        <th scope="row">Método de envío:</th>
                                        <td class="text-capitalize">
                    ...
                    <div class="row">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    @if (!empty($order->billing_lname))
                                        <tr>
                                            <th scope="row">Nombre de facturación:</th>
                                            <td>{{$order->billing_fname }} {{$order->billing_lname}}</td>
                                        </tr>
                                    @endif
                                    @if (!empty($order->billing_email))
                                        <tr>
                                            <th scope="row">Correo Electrónico de facturación:</th>
                                            <td>{{$order->billing_email}}</td>
                                        </tr>
                                    @endif
                                    @if (!empty($order->billing_number))
                                        <tr>
                                            <th scope="row">Número de facturación:</th>
                                            <td>{{$order->billing_number}}</td>
                                        </tr>
                                    @endif
                                    @if (!empty($order->billing_address))
                                        <tr>
                                            <th scope="row">Dirección de facturación:</th>
                                            <td>{{$order->billing_address}}</td>
                                        </tr>
                                    @endif
                                    @if (!empty($order->billing_city))
                                        <tr>
                                            <th scope="row">Ciudad de facturación:</th>
                                            <td>{{$order->billing_city}}</td>
                                        </tr>
                                    @endif
                                    @if (!empty($order->billing_country))
                                        <tr>
                                            <th scope="row">País de facturación:</th>
                        ...
                        <div class="col-lg-6">
                            <div>
                                <h3><strong>Detalles de envío</strong></h3>
                            </div>
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row">Correo electrónico de envío:</th>
                                        <td>{{$order->shpping_email}}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Número de envío:</th>
                                    ...
                                    <tr>
                                        <th scope="row">Ciudad de envío:</th>
                                        <td>{{$order->shpping_city}}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">País de envío:</th>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div>
                                <h3><strong>Productos pedidos</strong></h3>
                            </div>
