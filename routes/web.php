...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    /**
     * =======================================================
     *  Documentos ISO Management
     * =======================================================
     */
    Route::group(['middleware' => 'checkpermission:Quality Management'], function () {
        Route::get('/documentos-iso', 'Admin\DocumentoIsoController@index')->name('admin.documento_iso.index');
        Route::get('/documentos-iso/create', 'Admin\DocumentoIsoController@create')->name('admin.documento_iso.create');
        Route::post('/documentos-iso/store', 'Admin\DocumentoIsoController@store')->name('admin.documento_iso.store');
        Route::get('/documentos-iso/{id}/edit', 'Admin\DocumentoIsoController@edit')->name('admin.documento_iso.edit');
        Route::put('/documentos-iso/{id}/update', 'Admin\DocumentoIsoController@update')->name('admin.documento_iso.update');
        Route::post('/documentos-iso/{id}/delete', 'Admin\DocumentoIsoController@delete')->name('admin.documento_iso.delete');
        Route::post('/documentos-iso/bulk-delete', 'Admin\DocumentoIsoController@bulkDelete')->name('admin.documento_iso.bulkDelete');
    });
