...
class ForgotController extends Controller
{
    ...
    public function forgot(Request $request)
    {
        ...
        if (User::where('email', '=', $request->email)->count() > 0) {
            ...
            Session::flash('success', 'Su contraseña se restableció con éxito. Por favor revise su correo electrónico para obtener una nueva contraseña.');
            return back();
        } else {

            // user not found
            Session::flash('err', 'No se encontró ninguna cuenta con este correo electrónico.');
            return back();
        }
    }
}
