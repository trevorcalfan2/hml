...
class UserController extends Controller
{
    ...
    public function profileupdate(Request $request)
    {
        ...
        Session::flash('success', '¡Actualización de perfil exitosa!');
        return back();
    }
    ...
    public function reset(Request $request)
    {
        ...
        if (!empty($user->password)) {
            if (!Hash::check($request->current_password, $user->password)) {
                return back()->with('error', __('La contraseña actual no coincide.'));
            }
        }
        ...
        if ($request->new_password == $request->confirmation_password) {
            ...
            return back()->with('error', __('La confirmacion de contraseña no coincide.'));
        }

        $user->update($input);

        Session::flash('success', 'Cambia con éxito tu contraseña');
        return back();
    }
    ...
    public function shippingdetails()
    {
       ...
       $ccodes = [["code" => "+51", "name" => "Peru"],["code" => "+57", "name" => "Colombia"]];
    ...
    public function shippingupdate(Request $request)
    {
        ...
        Session::flash('success', 'Actualización de detalles de envío con éxito.');
        return back();
    }
    ...
    public function billingupdate(Request $request)
    {
        ...
        Session::flash('success', 'Actualización de detalles de facturación con éxito.');
        return back();
    }
}
